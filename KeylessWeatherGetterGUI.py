...
layout = [ [sg.Menu(menu_def, tearoff=False)],
           [sg.Txt('Enter your city, state, and/or zipcode to get the current weather', font=("Noteworthy", 20), text_color='#f4d1ab', background_color='#ad9b88')],      
           [sg.In(size=(71, 1), key='address', justification="left")],              
